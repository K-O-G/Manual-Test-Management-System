...
namespace WebUI.Controllers
{
    public class PrioritiesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PriorityId,PriorityName,PriorityDescription,PriorityColor")] Priority priority)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PriorityId,PriorityName,PriorityDescription,PriorityColor")] Priority priority)
        {
            if (ModelState.IsValid)
            {
